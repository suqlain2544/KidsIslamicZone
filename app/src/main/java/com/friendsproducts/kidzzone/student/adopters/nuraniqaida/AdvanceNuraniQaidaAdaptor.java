...
public class AdvanceNuraniQaidaAdaptor extends RecyclerView.Adapter<AdvanceNuraniQaidaAdaptor.MyView> {
    private Context ctx;
    private List<NQData> nqData;
    String array[] ;

    public AdvanceNuraniQaidaAdaptor(Context ctx, List<NQData> nqData, String[] array) {
        this.ctx = ctx;
        this.nqData = nqData;
        this.array = array;
    }
    ...
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view=layoutInflater.inflate(R.layout.nqlist,parent,false);
    ...
    public static class MyView extends RecyclerView.ViewHolder{
        ...
        public MyView(View itemView) {
            super(itemView);
            card_iv = (ImageView) itemView.findViewById(R.id.nqimage);
            cardView = (CardView) itemView.findViewById(R.id.nqcardview);
        }
    }
