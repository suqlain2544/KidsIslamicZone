package com.friendsproducts.kidzzone.namaz_qibla.adhanalarm;
...
public class Preferences {
    ...
    public float[] getApt() {
        ...
        apt[0] = mSharedPreferences.getFloat(KEY_ALTITUDE, (float) com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location.DEFAULT_SEA_LEVEL);
        apt[1] = mSharedPreferences.getFloat(KEY_PRESSURE, (float) com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location.DEFAULT_PRESSURE);
        apt[2] = mSharedPreferences.getFloat(KEY_TEMPERATURE, (float) com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location.DEFAULT_TEMPERATURE);
        return apt;
    }
...
//            Utils.updateWidgets(context);
    ...
    public com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location getJitlLocation() {
        final float[] latLong = getLocation();
        com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location location = new com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Location(
