...
import com.friendsproducts.kidzzone.namaz_qibla.adhanalarm.view.QiblaCompassView;
import com.friendsproducts.kidzzone.namaz_qibla.jitl.Jitl;
import com.friendsproducts.kidzzone.namaz_qibla.jitl.astro.Direction;
...
public class QiblaCompassFragment extends Fragment {
    ...
    private void updateDms() {
        ...
        sQiblaDirection = (float) qibla
                .getDecimalValue(Direction.NORTH);
